-- App is IDR-only: default currency and backfill existing rows.

alter table public.bills alter column currency set default 'IDR';

update public.bills set currency = 'IDR';
